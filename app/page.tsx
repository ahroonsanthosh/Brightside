    ...
    <section className="bg-[#3D5A3C] py-16 md:py-20 px-6">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-16 items-center">
        <div className="md:col-span-3">
          ...
          >
            A place for people who care what&rsquo;s in their cup.
          </h2>
          <p className="mt-4 text-white/65 text-base font-light leading-relaxed max-w-md">
            We opened Bright Side to give Cork a caf&eacute; that takes the craft seriously without losing the warmth. Specialty espresso, food made fresh daily, and a corner on Washington Street that feels like yours.
          </p>
        </div>
  ...
  return (
    <main className="relative overflow-x-hidden">
      ...
      <CafeCinematicHero
        ...
        productImageAlt="Bright Side café"
        scrollLength={3800}
      />
      ...
      <CafeCinematicHero
        ...
        productImageAlt="Bright Side food"
        scrollLength={3200}
      />
